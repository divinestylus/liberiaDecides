...
let
    votingCategories = document.querySelectorAll('.sidebar-card'),
...
function displayCandidates() {
    ...
    votingCategories = Array.from(votingCategories);
    if (votingCategories.length > 0) {
        votingCategories[0].classList.add('active-sidebar-card');
    }
    votingCategories.forEach(categories => {
        categories.addEventListener('click', (e) => {
            ...
            votingCategories[0].classList.remove('active-sidebar-card');
